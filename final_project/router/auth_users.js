...
// Else return true (username is available)
...
regd_users.put("/auth/review/:isbn", (req, res) => {
    ...
    console.log("req.session.authorization?.username", username);
  ...
  regd_users.delete("/auth/review/:isbn", (req, res) => {
    ...
    if (!book.reviews[username]) {
        return res.status(403).json({ message: "You are not authorized to delete this review or no review exists." });
    }
